...
if not SKIP_CUDA_BUILD:
    ...
    if HIP_BUILD:
        ...
        # Local Windows build for RTX 4070 SUPER (Ada, sm_89).
        # The upstream default builds many architectures; on Windows this can
        # generate huge fatbin C files and exhaust MSVC compiler heap space.
